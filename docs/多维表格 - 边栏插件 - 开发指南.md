...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZjU2NWFlZjE3OGZmYjM1MjZjNWU1YWZmNjkyNDJiYThfZTU1NTBkNDkwYzcxYzcxNDg3MzExNjM4NzhiYWM3MThfSUQ6NzM4MzcyNzkwMzYxNDE0MDQ0NF8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZGVmOTc1YzA5OTEyYTg5NTRmNTVjMzcwNjY2M2Y5ZDBfOGI3ZjQ0YjExMzE5MmQ0OGViMjE3ZWI2ZWZmOTNjZGJfSUQ6NzM1MTY4OTgzNDc0NTE4NDI4NF8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=N2UwOTkyNjhmYzJjZGZiNzg0N2NmMzM2NDU1NzVlZjdfZmM0OTBjZGFhMjhmMWQ5ZTI2ZmY5MWU0NzQyYzc1ZDBfSUQ6NzM1MTY4OTgzNjU5ODkzNTU1M18xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ODk3ZWZkNzQ4YzVhMThiOGMxOGVjNjRiZGFhODY1NjVfMTg4YzU2NjIxMjUyZTBmNGQxZDdiMDdmM2VlYzJhYTVfSUQ6NzM1MTY4OTgzNjMzMDQ2NzM1Nl8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)
...
participant BaseWeb as Base 网页
participant API as BaseOpenAPI
participant DB as Base DB

User->>BaseWeb: 生成 PersonalBaseToken
BaseWeb->>User: 返回 PersonalBaseToken
User->>API: 使用 PersonalBaseToken 调用 OpenAPI
API->>DB: 读写 Base 数据
DB->>API: 返回成功/失败
API->>User: OpenAPI 响应
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZjhmZjAzN2EyYmEzNjYxNTIxYzk1MDc0ZWQ1OGJjNjhfYTQ5MDdmMDdmNWM0Y2E5YTA3NWVmYTViZTMyY2FlNDJfSUQ6NzM1MTY4OTgzNDQ3MTM0MjA4Ml8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MzI2YjgyOGU2OGQ1ZWNhODlmMTU3M2IzZjQxN2Q5NWNfNWMzMzNhNTIyNzk1ZmQ1MTkxNzQzNGU5NzM5ZTVkMDlfSUQ6NzM1MTY4OTgzNDczNjE3MzA4NF8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
|---|---|
|协议和方法|HTTP GET|
|域名<br>与 OpenAPI 不同|https://base\-api\.feishu\.cn<br>https://base\-api\.larksuite\.com|
...
|QueryParam|```JSON<br>filter:CurrentValue.[多行文本]="双向关联测试"<br>sort:"["字段1 DESC"]"<br>page_size:20<br>```|
|Response<br><br><br>|```JSON<br>{<br>    "code": 0,<br>    "data": {<br>        "has_more": true,<br>        "items": [<br>            {<br>                "fields": {<br>                    "其他表": [<br>                        {<br>                            "record_ids": [<br>                                "rec2ltnYkQ",<br>                                "recZE5zqYP"<br>                            ],<br>                            "table_id": "tblvC2gefQet5bTV",<br>                            "text": "测试,测试2",<br>                            "text_arr": [<br>                                "测试",<br>                                "测试2"<br>                            ],<br>                            "type": "text"<br>                        }<br>                    ],<br>                },<br>                "id": "rec0iAsbhD",<br>                "record_id": "rec0iAsbhD"<br>            }<br>        ],<br>        "page_token": "rec0iAsbhD",<br>        "total": 9<br>    },<br>    "msg": "success"<br>}<br>```|
...
我们在 github 和 https://replit\.com （可选，或者直接clone github 上模板（见下文中的“模板”）即可）中提供了一系列的模板帮助你快速开发，请根据你的业务场景和技术栈，选择对应的模板Fork 到你的 Replit 账号内，或导入 GitHub 进行开发。
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=NTYyY2Y4MWI5MWQyNDVhZDhkNWI5ZDI0ZDJkM2RjZDBfODAxZDY1ZTg5NGY3MGFjN2JmNmQ4Mzk2ZGRjNWIyZWNfSUQ6NzM1MTY4OTgzNzMyMDUwMzI5N18xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)
...
- 支持通过 Markdown 编辑器生成 Markdown 语句，需要注意的是，仅支持common markdown语法\+html，如果不确定哪些是common markdown语法，可以借助[此工具](https://ext.baseopendev.com/ext/Lark-Base-Team_react-markdown-test_1767086334554_573/1767086343880/index.html)辅助编辑你的插件介绍。
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=OTAwNWJkMzVmZWFjYWRhN2QxY2M2MTE4YTZiNzc2ZmVfNWFhMWZkNDMzZWRhNmI0NWRiMDYxOTFkMzI4M2Q3MjFfSUQ6NzM1MTY4OTgzMzQxMDQ0NTMxM18xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MGRjNjM0YjI1MGRiODU5MzE0OGNmYjFjYmIyZmVmY2NfZTY3YzY2OGM1MGM5N2M1YThmMTQyZDBhYWQyMWUxN2JfSUQ6NzM1MTY4OTgzNTcwOTMwMDc2NF8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)

色板

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MGRlZTFlNWQ0OWY1MTkyOWM1YTlmNjM4NmFjOGRkMTZfY2QxMGExN2YzODNkOTU2ZjU3MTE4NTY2MTAwMThmNmRfSUQ6NzM1MTY4OTgzMzg3NzY2Nzg2OF8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZDhmYmQzNTIyYjgxMTM2YTA3ZGFlZTVlNzU3MDlmODZfZGNhY2Y0MTg0OGZiMTIyOTZlMDNmMjk1NWM4ODk5NjVfSUQ6NzM1MTY4OTgzNTY0NjQzNTM1Nl8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)



在视觉上突出插件的功能和特性，而不是简单地截图。建议使用彩色背景，以确保图像在所有主题（包括深色模式）中脱颖而出。每张图片都应侧重于介绍插件的一个功能点，使用户感受到价值。

![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=NTkwNjhjYTBmMDRkZjAzYjY4NWJiODhmZGY1NGY1ZWNfOGI5MWRhODRiN2FiOGJlMmRlY2UxYjA3OWM4M2FmNDVfSUQ6NzM1MTY4OTgzNDc0NTIwMDY2OF8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=Njc3NDQ0MTNkYzY3MjYzNjQ5NDViYTUyNWUzN2M5YzdfMDc5YTEyNjMxMDYyOGUzNDIwN2M5NWE0MzI4YWYyMGVfSUQ6NzM1MTY4OTgzMzU5NTIyNDA2Nl8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MDI1NDRjNTBkMjE2ODI2YWRhNzM4ZDA3YzFhMTUzZTBfNDBkYTE0MDFkNWJiNTFmZmY5ZTJkZmNiMjAzMDk3ZWNfSUQ6NzM1MTY4OTgzNzUwNTUyNzgwOV8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)



## 国际化

由于国际化和市场团队的要求，发布到市场的插件必须通过 i18n 能力支持中、日、英三种语言。请务必使用 [插件 ](https://bots.byteintl.net/store/bot/7337155255983079442?bot_id=true)[i18n json 翻译](https://bots.byteintl.net/store/bot/7337155255983079442?bot_id=true) 工具完成国际化，以确保专有名词的正确性。输入中文 json，工具将翻译并返回日、英两种语言的 json 结构。



![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=NDEyNWVlM2I0NTdkNGEzMmFkMjI5ZmFmM2ZkYTU4NjZfZTI5M2EzM2ZlMTM4NjE5NDdjMThkM2JkNGJjZWIxNzFfSUQ6NzM1MTY4OTgzNzE0MDgwMzU4Nl8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZGM1ZGUwZWUzMmVjYmM3NDdjMzBhNWY3ZmM2ZmY3NTZfOTU5ZWIwNTAzMWU5NTU3ODNjNzYzNjRlY2UzNjU2YzRfSUQ6NzM1MTY4OTgzNDE0MDU5ODI3NF8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZTkwMmYxNGJiOWQ0OTgyYzc2ODgxNTQ3YzZlMTIyNzJfYjc4NmNjNDRhZmE2MTBlZDk2MTJiNjgwOWJlMzY1ZjlfSUQ6NzM1MTY4OTgzNDI0NTU1NDIwNF8xNzgyMjkzOTI4OjE3ODIzODAzMjhfVjM)
...
我们将直接静态部署前端产物（或者用你自己的服务器，提供给我们运行地址），以避免二次构建打包失败，首先需要指定构建产物目录，比如指定部署dist/index\.html，
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MjcxNGY3MTExNDFhYmU1YjAxN2FmMzA1NTBmY2Y2YWZfZTNmOTYyNGQ0MzIxZWY5NDU4ODRhZjE4ZTI2YTExNWFfSUQ6NzU3NDYzNDIyNTc0MDMxOTY4OF8xNzgyMjkzOTI3OjE3ODIzODAzMjdfVjM)

2. 禁止使用history路由，请使用hash路由

3. 填写[共享表单](https://feishu.feishu.cn/share/base/form/shrcnwTXnFVAbMPOSeaOFwIAnbf)
...
![Image](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=